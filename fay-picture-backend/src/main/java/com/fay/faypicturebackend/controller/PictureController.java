...
import com.fay.faypicturebackend.model.dto.picture.PictureEditRequest;
import com.fay.faypicturebackend.model.dto.picture.PictureQueryRequest;
import com.fay.faypicturebackend.model.dto.picture.PictureUpdateRequest;
...
public class PictureController {
    ...
    public BaseResponse<PictureTagCategory> listPictureTagCategory() {
        ...
        List<String> tagList = Arrays.asList("电脑壁纸", "手机壁纸", "二次元", "有趣", "可爱", "校园", "极简", "科幻", "情绪");
        List<String> categoryList = Arrays.asList("壁纸", "头像", "颜值", "影视", "其它");
